...
func TestTransferTx(t *testing.T) {
	...
	//running n concurrent transfer transactions
	...
	for i := 0; i < n; i++ {
		...
		fmt.Println("txt during balance: ", fromAccount.Balance, toAccount.Balance)
